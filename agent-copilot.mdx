...
- **Refine** and **Send to Draft** (Zendesk)
...
**Send to Draft:** Inserts the current resolution (including any refinement) into the Zendesk ticket reply editor so you can edit and send it from the ticket. This uses Zendesk's draft composer and is not available on Salesforce or Jira Service Management.
