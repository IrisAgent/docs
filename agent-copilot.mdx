...
You can also embed the existing [AI Search widget in Confluence](/deploying-irisagent/Internal-AI-Search-on-Confluence). It uses the same shared widget key and knowledge configuration as your AI Search deployment, with source links and follow-up questions. It does not require an additional employee sign-in or receive the current ticket's context.
