---
title: "Segment Tickets and Chats by Product"
...
<Warning>New mappings apply only to tickets ingested after you save the configuration. Existing tickets are not reclassified.</Warning>
