...
\
A Zendesk user (with`write`access) in your team should follow the instructions provided [here to connect Zendesk](https://irisagent.com/zd-docs/) to connect IrisAgent to your Zendesk account. Ensure that this user is assigned to the SAML application of IrisAgent from your Okta dashboard.
