...
If WhatsApp is not yet a channel in your Zendesk account, follow the official Zendesk guide: [Welcome to WhatsApp in Zendesk Support](https://support.zendesk.com/hc/en-us/articles/4408821809434-Welcome-to-WhatsApp-in-Zendesk-Support).
...
1. In the IrisAgent dashboard, open **Deploy** → **Chat channels** from the left sidebar
2. Select the **Salesforce Service Cloud** configuration
3. Enter:
...
1. In the IrisAgent dashboard, open **Deploy** → **Chat channels** from the left sidebar
2. Select the **WhatsApp Cloud API** configuration
3. Enter:
   - **WABA ID**
   - **Phone Number ID**
...
4. Map escalation targets:
   - **Zendesk path**: in the default chatbot configuration, set **Handoff** to **Start a live chat** and add any ticket tags your Zendesk routing trigger expects. IrisAgent adds those tags and passes control to Agent Workspace; the Zendesk trigger assigns the queue or group. See [Configure Human Handoff and Zendesk Routing](/deploying-irisagent/Chatbot-Automation-on-Zendesk-Messaging#step-5-configure-human-handoff-and-zendesk-routing)
...
- [Zendesk: Welcome to WhatsApp in Zendesk Support](https://support.zendesk.com/hc/en-us/articles/4408821809434-Welcome-to-WhatsApp-in-Zendesk-Support)
