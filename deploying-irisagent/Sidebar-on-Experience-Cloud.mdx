...
Experience Cloud support for the sidebar ships in **IrisAgent Sidebar v1.4.0+**. If you have an older version, upgrade to the latest package version. If this is a fresh install, follow the [Salesforce data source guide](/data-sources/Salesforce) first, then upgrade.
