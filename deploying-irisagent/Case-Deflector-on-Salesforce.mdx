...
The Case Deflector ships in **IrisAgent Sidebar v1.3.0+**. The current version is **v1.4.6**. If you already have an older version installed, install over it with the link below to upgrade in place. If this is a fresh install, follow the [Salesforce data source guide](/data-sources/Salesforce) first.
