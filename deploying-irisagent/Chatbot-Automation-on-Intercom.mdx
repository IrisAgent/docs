...
1. In the IrisAgent dashboard, open **Deploy** → **Chat channels** from the left sidebar, then find the **Intercom Chat** card and click the settings (gear) icon to open its configuration panel.
