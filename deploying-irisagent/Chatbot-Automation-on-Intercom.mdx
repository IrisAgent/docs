...
1. Navigate to the Intercom Chat configuration page in your IrisAgent account.
...
\
You can optionally enable chat filtering to control which Intercom conversations IrisAgent processes. This allows you to filter conversations based on tags or apply custom filtering logic.
