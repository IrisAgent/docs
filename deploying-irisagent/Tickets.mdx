---
title: "Tickets"
description: "Use Case Triggers to automate incoming tickets: auto-respond with AI answers, route to the right team, tag, update fields, and post internal notes"
---

Once your ticketing system is connected, IrisAgent can act on incoming tickets automatically through **Case Triggers**. A trigger is a set of **Conditions** (which tickets it applies to) paired with **Actions** (what IrisAgent does to them). Conditions are evaluated with AND logic, so a trigger fires only when every condition matches.

This lets you go well beyond auto-responding. The same trigger engine handles routing, triage, tagging, and enrichment.

Case Triggers work across your connected ticketing systems, including Zendesk, Freshdesk, Salesforce, Jira, HubSpot, Intercom, and Zoho, as well as your [Outlook](/deploying-irisagent/Outlook) inbox.
...
- [Workflows](/configuring-ai-and-automation/Workflows) covers the drag-and-drop trigger builder, plain-English procedures for chat, voice, and agent assist, and the AI insights private note toggle.
