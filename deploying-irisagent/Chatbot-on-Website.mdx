...
1. Paste the code snippet shown in the **body** section of your website.
   ...
   ```
2. You can customize the bot logo, brand color, etc. on the same page.
3. You can see all the conversations that happened on the chatbot on the **"Conversations"** page under "IrisGPT".
4. That’s it, done! You should be seeing the IrisAgent chatbot on your website.