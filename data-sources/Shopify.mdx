...
<Note>
  A Shopify theme app embed is not included in the initial release. Connecting Shopify does not add the chatbot JavaScript to the storefront automatically. Product catalog synchronization and authenticated customer order lookup are also not included.
</Note>
