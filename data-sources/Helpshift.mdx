...
## Connect Helpshift to IrisAgent
...
- Go to the [IrisAgent Dashboard](https://web.irisagent.com/) and sign in with Google, Microsoft, or Okta SSO.
  ...
  />
<br/>
- Share your **Helpshift domain** (the `<domain>` in `<domain>.helpshift.com`) and the **API key** generated above with the IrisAgent team. IrisAgent validates the key and starts ingesting your issues.
<br/>
...
- **Public help center or website**: add the URL under **Data Sources → Website** and IrisAgent will ingest the main page and all sub-pages.
