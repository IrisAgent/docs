...
- Click on **Connect with Hubspot** and enter the following information.
  ...
  - **Create a Private App Access Token**: Required scopes: **tickets** and **sales-email-read** (Hubspot stores ticket comments as Sales engagement objects under the hood)\
