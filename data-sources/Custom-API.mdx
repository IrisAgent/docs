...
| **API Credential** | Select a credential from Step 2, or leave as _None_ for unauthenticated requests |
...
| Field | Description |
| --- | --- |
| **Run this action first** | Select another Custom API to run before this one. Its Expression result is captured. Leave as _None_ to disable chaining |
